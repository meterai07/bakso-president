<footer>
    ...
    <div class="flex justify-between w-full px-[100px] py-4 items-center bg-primary-500">
        <p class="text-base text-neutral-900">Copyright &copy; 2023 by Bakso President. All Rights Reserved.</p>
        <div class="flex gap-6">
            <a href="https://www.instagram.com/baksopresidentmalang/" target="_blank"><img src="../assets/icons/cib_instagram.svg" alt="Instagram"></a>
            <a href="https://www.tiktok.com/@bakso_president_malang" target="_blank"><img src="../assets/icons/cib_tiktok.svg" alt="Tiktok"></a>
        </div>
    </div>
</footer>
