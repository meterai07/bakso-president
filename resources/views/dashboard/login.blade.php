    ...
    <div class="flex flex-col items-center justify-center h-screen bg-primary-100">
        <div class="flex flex-col items-center justify-center w-96 bg-cover rounded-[30px] shadow-lg p-5" style="background-image: url(../assets/img/login-bg.svg)">
            ...
            <div class="flex flex-col w-full p-6 space-y-6">
                <input type="email" name="email" id="email" placeholder="Email" class="px-4 py-2 border border-neutral-200 rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-gray-200 focus:border-transparent focus:duration-500">
                <input type="password" name="password" id="password" placeholder="Password" class="px-4 py-2 border border-neutral-200 rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-gray-200 focus:border-transparent focus:duration-500">
